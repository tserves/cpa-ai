...
import { 
  ...
  Bot, ChevronLeft, ChevronRight, LogOut, CalendarDays, ArrowDownToLine, UserCog, Clock, NotebookPen, Sparkles, FilePlus, Database
} from 'lucide-react';
...
const navItems = [
  ...
  { path: '/financial-reports', label: 'Financial Reports', icon: Database },
];
