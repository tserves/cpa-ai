...
import { 
  ...
  Bot, ChevronLeft, ChevronRight, LogOut, CalendarDays, ArrowDownToLine, UserCog, Clock, NotebookPen, Sparkles, FilePlus, BarChart2
} from 'lucide-react';
...
const navItems = [
  ...
  { path: '/quotes', label: 'Quotes', icon: FilePlus },
  ...
  { path: '/financial-reports', label: 'Financial Reports', icon: BarChart2 },
];
