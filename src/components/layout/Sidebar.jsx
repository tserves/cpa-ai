...
import { 
  ...
  Bot, ChevronLeft, ChevronRight, LogOut, CalendarDays, ArrowDownToLine, UserCog, Clock, NotebookPen, Sparkles, FilePlus, Layers
} from 'lucide-react';
...
const navItems = [
  ...
  { path: '/book-keeper', label: 'Book Keeper', icon: Layers },
];
